...
# create full network Subnets, Routing tables, Internet Gateway, NAT Gateway
...
module "retail_app_eks" {
  ...
  eks_managed_node_groups = {
    default = {
      ...
      instance_types = ["c7i-flex.large"] # cost-effective instance type for development/testing
